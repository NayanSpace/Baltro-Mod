...
function love.draw(...)
    ...
    love.graphics.print("[1] Hand Tracker  [2] Deck Tracker  [3] Possible Combos  [4] Combo Levels  [5] Jokers  [6] Boss Blind Info", 20, 10)
